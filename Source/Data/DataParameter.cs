...
*/
        ...
        {
            return new DataParameter {DataType = DataType.Blob, Name = name, Value = value};
        }
        ...
        {
            return new DataParameter {DataType = DataType.Image, Name = name, Value = value};
        }

        public static DataParameter Boolean(string name, bool value)
        {
            return new DataParameter {DataType = DataType.Boolean, Name = name, Value = value};
        }

        [CLSCompliant(false)]
        public static DataParameter SByte(string name, sbyte value)
        {
            return new DataParameter {DataType = DataType.SByte, Name = name, Value = value};
        }

        public static DataParameter Int16(string name, short value)
        {
            return new DataParameter {DataType = DataType.Int16, Name = name, Value = value};
        }

        public static DataParameter Int32(string name, int value)
        {
            return new DataParameter {DataType = DataType.Int32, Name = name, Value = value};
        }

        public static DataParameter Int64(string name, long value)
        {
            return new DataParameter {DataType = DataType.Int64, Name = name, Value = value};
        }

        public static DataParameter Byte(string name, byte value)
        {
            return new DataParameter {DataType = DataType.Byte, Name = name, Value = value};
        }

        [CLSCompliant(false)]
        public static DataParameter UInt16(string name, ushort value)
        {
            return new DataParameter {DataType = DataType.UInt16, Name = name, Value = value};
        }

        [CLSCompliant(false)]
        public static DataParameter UInt32(string name, uint value)
        {
            return new DataParameter {DataType = DataType.UInt32, Name = name, Value = value};
        }

        [CLSCompliant(false)]
        public static DataParameter UInt64(string name, ulong value)
        {
            return new DataParameter {DataType = DataType.UInt64, Name = name, Value = value};
        }

        public static DataParameter Single(string name, float value)
        {
            return new DataParameter {DataType = DataType.Single, Name = name, Value = value};
        }

        public static DataParameter Double(string name, double value)
        {
            return new DataParameter {DataType = DataType.Double, Name = name, Value = value};
        }

        public static DataParameter Decimal(string name, decimal value)
        {
            return new DataParameter {DataType = DataType.Decimal, Name = name, Value = value};
        }

        public static DataParameter Money(string name, decimal value)
        {
            return new DataParameter {DataType = DataType.Money, Name = name, Value = value};
        }

        public static DataParameter SmallMoney(string name, decimal value)
        {
            return new DataParameter {DataType = DataType.SmallMoney, Name = name, Value = value};
        }

        public static DataParameter Guid(string name, Guid value)
        {
            return new DataParameter {DataType = DataType.Guid, Name = name, Value = value};
        }

        public static DataParameter Date(string name, DateTime value)
        {
            return new DataParameter {DataType = DataType.Date, Name = name, Value = value};
        }

        public static DataParameter Time(string name, TimeSpan value)
        {
            return new DataParameter {DataType = DataType.Time, Name = name, Value = value};
        }

        public static DataParameter DateTime(string name, DateTime value)
        {
            return new DataParameter {DataType = DataType.DateTime, Name = name, Value = value};
        }

        public static DataParameter DateTime2(string name, DateTime value)
        {
            return new DataParameter {DataType = DataType.DateTime2, Name = name, Value = value};
        }

        public static DataParameter SmallDateTime(string name, DateTime value)
        {
            return new DataParameter {DataType = DataType.SmallDateTime, Name = name, Value = value};
        }

        public static DataParameter DateTimeOffset(string name, DateTimeOffset value)
        {
            return new DataParameter {DataType = DataType.DateTimeOffset, Name = name, Value = value};
        }

        public static DataParameter Timestamp(string name, byte[] value)
        {
            return new DataParameter {DataType = DataType.Timestamp, Name = name, Value = value};
        }

        public static DataParameter Xml(string name, string value)
        {
            return new DataParameter {DataType = DataType.Xml, Name = name, Value = value};
        }
        ...
        {
            return new DataParameter {DataType = DataType.Variant, Name = name, Value = value};
        }

        public static DataParameter VarNumeric(string name, decimal value)
        {
            return new DataParameter {DataType = DataType.VarNumeric, Name = name, Value = value};
        }

        public static DataParameter Udt(string name, object value)
        {
            return new DataParameter {DataType = DataType.Udt, Name = name, Value = value};
        }
