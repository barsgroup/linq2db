...
namespace Bars2Db.SqlQuery.QueryElements.SqlElements
{
        ...
        ISqlDataType
    {
        ...
        public static readonly ISqlDataType Undefined = new SqlDataType(DataType.Undefined, typeof(object), null, null,
            null);
        ...
        private static TypeInfo[] SortTypeInfo(params TypeInfo[] info)
        {
        ...
        private static readonly TypeInfo[] _typeInfo = SortTypeInfo
            (
                ...
                new TypeInfo(DataType.Decimal, 17, Len(decimal.MaxValue), Len(decimal.MaxValue),
                    Len(decimal.MinValue) + 1),
        ...
        {
            return _typeInfo[(int) dbType].MaxLength;
        }

        public static int GetMaxPrecision(DataType dbType)
        {
            return _typeInfo[(int) dbType].MaxPrecision;
        }

        public static int GetMaxScale(DataType dbType)
        {
            return _typeInfo[(int) dbType].MaxScale;
        }

        public static int GetMaxDisplaySize(DataType dbType)
        {
            return _typeInfo[(int) dbType].MaxDisplaySize;
        }
        ...
        public static ISqlDataType GetDataType(Type type)
        {
            ...
            switch (underlyingType.GetTypeCodeEx())
            {
                ...
                case TypeCode.Object:
                    ...
                    if (underlyingType == typeof(Binary)) return LinqBinary;
        ...
        private SqlDataType(DataType dbType, Type type, Func<DataType, int> length, int precision, int scale)
            : this(dbType, type, length(dbType), precision, scale)
        {
        }

        private SqlDataType(DataType dbType, Type type, int length, Func<DataType, int> precision, int scale)
        ...
        public static readonly ISqlDataType DbDecimal = new SqlDataType(DataType.Decimal, typeof(decimal), 0,
            GetMaxPrecision, 10);

        public static readonly ISqlDataType DbMoney = new SqlDataType(DataType.Money, typeof(decimal), 0,
            GetMaxPrecision, 4);

        public static readonly ISqlDataType DbSmallMoney = new SqlDataType(DataType.SmallMoney, typeof(decimal), 0,
            GetMaxPrecision, 4);
        ...
        public static readonly ISqlDataType DbSmallDateTime = new SqlDataType(DataType.SmallDateTime, typeof(DateTime),
            0, 0, 0);
        ...
        public static readonly ISqlDataType DbDateTimeOffset = new SqlDataType(DataType.DateTimeOffset,
            typeof(DateTimeOffset), 0, 0, 0);

        public static readonly ISqlDataType DbChar = new SqlDataType(DataType.Char, typeof(string), GetMaxLength, 0, 0);

        public static readonly ISqlDataType DbVarChar = new SqlDataType(DataType.VarChar, typeof(string), GetMaxLength,
            0, 0);
        ...
        public static readonly ISqlDataType DbNVarChar = new SqlDataType(DataType.NVarChar, typeof(string), GetMaxLength,
            0, 0);

        public static readonly ISqlDataType DbNText = new SqlDataType(DataType.NText, typeof(string), GetMaxLength, 0, 0);

        public static readonly ISqlDataType DbBinary = new SqlDataType(DataType.Binary, typeof(byte[]), GetMaxLength, 0,
            0);

        public static readonly ISqlDataType DbVarBinary = new SqlDataType(DataType.VarBinary, typeof(byte[]),
            GetMaxLength, 0, 0);
        ...
        public static readonly ISqlDataType UInt64 = new SqlDataType(DataType.UInt64, typeof(ulong), 0,
            ulong.MaxValue.ToString().Length, 0);
        ...
        public static readonly ISqlDataType CharArray = new SqlDataType(DataType.NVarChar, typeof(char[]), GetMaxLength,
            0, 0);
        ...
        public static readonly ISqlDataType SqlDateTime = new SqlDataType(DataType.DateTime, typeof(SqlDateTime), 0, 0,
            0);

        public static readonly ISqlDataType SqlDecimal = new SqlDataType(DataType.Decimal, typeof(SqlDecimal), 0,
            GetMaxPrecision, 10);

        public static readonly ISqlDataType SqlMoney = new SqlDataType(DataType.Money, typeof(SqlMoney), 0,
            GetMaxPrecision, 4);

        public static readonly ISqlDataType SqlString = new SqlDataType(DataType.NVarChar, typeof(SqlString),
            GetMaxLength, 0, 0);

        public static readonly ISqlDataType SqlBinary = new SqlDataType(DataType.Binary, typeof(SqlBinary), GetMaxLength,
            0, 0);

        public static readonly ISqlDataType SqlGuid = new SqlDataType(DataType.Guid, typeof(SqlGuid), 0, 0, 0);

        public static readonly ISqlDataType SqlBytes = new SqlDataType(DataType.Image, typeof(SqlBytes), GetMaxLength, 0,
            0);

        public static readonly ISqlDataType SqlChars = new SqlDataType(DataType.Text, typeof(SqlChars), GetMaxLength, 0,
            0);
