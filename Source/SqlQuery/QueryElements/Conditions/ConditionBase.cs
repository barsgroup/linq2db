namespace LinqToDB.SqlQuery.QueryElements.Conditions
{
        ...
        where T1 : ConditionBase<T1,T2>
    {
        public class Expr_
        {
            ...
            public T2 In   (ISelectQuery subQuery) { return Add(new InSubQuery(_expr, false, subQuery)); }
            public T2 NotIn(ISelectQuery subQuery) { return Add(new InSubQuery(_expr, true,  subQuery)); }
        ...
        public class Not_ : IConditionExpr<Expr_>
        {
            ...
            public Expr_ SubQuery(ISelectQuery selectQuery) { return Expr(selectQuery);            }
