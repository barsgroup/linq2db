namespace LinqToDB.SqlQuery.Search.SearchEx
{
    ...
    public class PathBuilderExSearchCache
    {
        ...
        public PathBuilderExSearchCache(Type sourceType, Type searchType)
        {
    ...
    public class PathBuilderEx<TBaseSearchInterface>
    {
        private readonly TypeGraphEx<TBaseSearchInterface> _typeGraph;

        private readonly Dictionary<Tuple<Type, Type>, PathBuilderExSearchCache> _cache = new Dictionary<Tuple<Type, Type>, PathBuilderExSearchCache>(); 

        public PathBuilderEx(TypeGraphEx<TBaseSearchInterface> typeGraph)
        {
        ...
        public LinkedList<CompositPropertyVertex> Find(TBaseSearchInterface source, Type searchType)
        {
            ...
            PathBuilderExSearchCache cachedResult;
            if (_cache.TryGetValue(key, out cachedResult))
            {
                return cachedResult.OptimizedPaths;
            }

            cachedResult = new PathBuilderExSearchCache(sourceType, searchType);
        ...
        public HashSet<PropertyInfoVertex> GetOrBuildPaths(IEnumerable<Type> sourceTypes, Type searchType, PathBuilderExSearchCache cache)
        {
        ...
        public static LinkedList<CompositPropertyVertex> OptimizePaths(HashSet<PropertyInfoVertex> propertyPaths, PathBuilderExSearchCache cache)
        {
        ...
        private static CompositPropertyVertex OptimizeNode(PropertyInfoVertex node, PathBuilderExSearchCache cache)
        {
        ...
        public HashSet<PropertyInfoVertex> BuildSearchTree(
            ...
            PathBuilderExSearchCache cache)
        {
