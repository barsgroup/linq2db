...
{
    internal class BulkCopyReader : IDataReader
    {
        ...
        private readonly Parameter _valueConverter = new Parameter();
                ...
                .Select(
                    c =>
                        c.DataType == DataType.Undefined
                            ? dataProvider.MappingSchema.GetDataType(c.MemberType).DataType
                            : c.DataType)
                .ToArray();
        }
        ...
        public DataTable GetSchemaTable()
        {
            ...
            for (var i = 0; i < _columns.Count; ++i)
            {
                ...
                row[SchemaTableColumn.DataType] = _dataProvider.ConvertParameterType(columnDescriptor.MemberType,
                    _columnTypes[i]);
