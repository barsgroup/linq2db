...
namespace Bars2Db.DataProvider
{
    public abstract class DynamicDataProviderBase : DataProviderBase
    {
        ...
        private Func<string, IDbConnection> _createConnection;
        ...
        public override Type DataReaderType
            => _dataReaderType ?? (_dataReaderType = Type.GetType(DataReaderTypeName, true));
            ...
            var pType =
                connectionType.Assembly.GetType(
                    parameterTypeName.Contains(".")
                        ? parameterTypeName
                        : connectionType.Namespace + "." + parameterTypeName, true);
            var dbType =
                connectionType.Assembly.GetType(
