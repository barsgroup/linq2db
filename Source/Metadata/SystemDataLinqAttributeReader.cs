...
using AssociationAttribute = Bars2Db.Mapping.AssociationAttribute;
using ColumnAttribute = Bars2Db.Mapping.ColumnAttribute;
using TableAttribute = Bars2Db.Mapping.TableAttribute;
