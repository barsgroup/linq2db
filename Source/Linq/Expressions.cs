    ...
    public static class Expressions
    {
                           ...
                           "", new Dictionary<MemberInfo, IExpressionInfo>
                               {
                                   ...
                                   {
                                       M(() => "".IndexOf(' ', 0, 0)),
                                       N(() => L<string, char, int, int, int>((obj, p0, p1, p2) => (Sql.CharIndex(p0, Sql.Left(obj, p2), p1) ?? 0) - 1))
                                   },
                                   {
                                       M(() => "".LastIndexOf("")), N(
                                           () => L<string, string, int>(
                                               (obj, p0) => p0.Length == 0
                                                                              ...
                                                                              : Sql.CharIndex(p0, obj).Value == 0
                                                                                    ? -1
                                                                                    : obj.Length - Sql.CharIndex(Sql.Reverse(p0), Sql.Reverse(obj)).Value - p0.Length + 1))
                                   },
                                   {
                                       M(() => "".LastIndexOf("", 0)), N(
                                           () => L<string, string, int, int>(
                                               (obj, p0, p1) => p0.Length == 0
                                                                                      ...
                                                                                      : Sql.CharIndex(p0, obj, p1 + 1).Value == 0
                                                                                            ? -1
                                                                                            : obj.Length -
                                                                                              Sql.CharIndex(Sql.Reverse(p0), Sql.Reverse(obj.Substring(p1, obj.Length - p1))).Value -
                                                                                              p0.Length + 1))
                                   },
                                   {
                                       M(() => "".LastIndexOf("", 0, 0)), N(
                                           () => L<string, string, int, int, int>(
                                               (obj, p0, p1, p2) => p0.Length == 0
                                                                                              ...
                                                                                              : Sql.CharIndex(p0, Sql.Left(obj, p1 + p2), p1 + 1).Value == 0
                                                                                                    ? -1
                                                                                                    : p1 + p2 - Sql.CharIndex(Sql.Reverse(p0), Sql.Reverse(obj.Substring(p1, p2))).Value -
                                                                                                      p0.Length + 1))
                                   },
                                   {
                                       M(() => "".LastIndexOf(' ')), N(
                                       ...
                                       M(() => "".LastIndexOf(' ', 0)), N(
                                           () => L<string, char, int, int>(
                                               (obj, p0, p1) => Sql.CharIndex(p0, obj, p1 + 1).Value == 0
                                                                                    ? -1
                                                                                    : obj.Length - Sql.CharIndex(p0, Sql.Reverse(obj.Substring(p1, obj.Length - p1))).Value))
                                   },
                                   {
                                       M(() => "".LastIndexOf(' ', 0, 0)),
                                       N(
                                   ...
                                   { M(() => "".PadLeft(0, ' ')), N(() => L<string, int, char, string>((obj, p0, p1) => Sql.PadLeft(obj, p0, p1))) },
                                   ...
                                   { M(() => "".Replace("", "")), N(() => L<string, string, string, string>((obj, p0, p1) => Sql.Replace(obj, p0, p1))) },
                                   { M(() => "".Replace(' ', ' ')), N(() => L<string, char, char, string>((obj, p0, p1) => Sql.Replace(obj, p0, p1))) },
                                   ...
                                   { M(() => string.CompareOrdinal("", "")), N(() => L<string, string, int>((s1, s2) => s1.CompareTo(s2))) },
                                   {
                                       ...
                                       N(
                                           () =>
                                           L<string, int, string, int, int, int>((s1, i1, s2, i2, l) => s1.Substring(i1, l).CompareTo(s2.Substring(i2, l))))
                                   },
...

                                   {
                                       ...
                                       N(
                                           ...
                                           L<string, int?, int?, string, string>(
                                               (p0, p1, p2, p3) => Sql.Left(p0, p1 - 1) + p3 + Sql.Right(p0, p0.Length - (p1 + p2 - 1))))
                                   },
                                   ...
                                   { M(() => DateTime.Now.Year), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Year, obj).Value)) },
                                   { M(() => DateTime.Now.Month), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Month, obj).Value)) },
                                   { M(() => DateTime.Now.DayOfYear), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.DayOfYear, obj).Value)) },
                                   { M(() => DateTime.Now.Day), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Day, obj).Value)) },
                                   { M(() => DateTime.Now.DayOfWeek), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.WeekDay, obj).Value - 1)) },
                                   { M(() => DateTime.Now.Hour), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Hour, obj).Value)) },
                                   { M(() => DateTime.Now.Minute), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Minute, obj).Value)) },
                                   { M(() => DateTime.Now.Second), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Second, obj).Value)) },
                                   { M(() => DateTime.Now.Millisecond), N(() => L<DateTime, int>(obj => Sql.DatePart(Sql.DateParts.Millisecond, obj).Value)) },
                                   { M(() => DateTime.Now.Date), N(() => L<DateTime, DateTime>(obj => Sql.Convert2(Sql.Date, obj))) },
                                   { M(() => DateTime.Now.TimeOfDay), N(() => L<DateTime, TimeSpan>(obj => Sql.DateToTime(Sql.Convert2(Sql.Time, obj)).Value)) },
                                   {
                                       M(() => DateTime.Now.AddYears(0)), N(() => L<DateTime, int, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Year, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddMonths(0)),
                                       N(() => L<DateTime, int, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Month, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddDays(0)),
                                       N(() => L<DateTime, double, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Day, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddHours(0)),
                                       N(() => L<DateTime, double, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Hour, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddMinutes(0)),
                                       N(() => L<DateTime, double, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Minute, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddSeconds(0)),
                                       N(() => L<DateTime, double, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Second, p0, obj).Value))
                                   },
                                   {
                                       M(() => DateTime.Now.AddMilliseconds(0)),
                                       N(() => L<DateTime, double, DateTime>((obj, p0) => Sql.DateAdd(Sql.DateParts.Millisecond, p0, obj).Value))
                                   },
                                   { M(() => new DateTime(0, 0, 0)), N(() => L<int, int, int, DateTime>((y, m, d) => Sql.MakeDateTime(y, m, d).Value)) },

                                   {
                                       ...
                                       N(
                                           ...
                                           L<int?, int?, int?, DateTime?>(
                                               (y, m, d) => (DateTime?)Sql.Convert(Sql.Date, y.ToString() + "-" + m.ToString() + "-" + d.ToString())))
                                   },
                                   {
                                       M(() => new DateTime(0, 0, 0, 0, 0, 0)),
                                       N(() => L<int, int, int, int, int, int, DateTime>((y, m, d, h, mm, s) => Sql.MakeDateTime(y, m, d, h, mm, s).Value))
                                   },
                                   {
                                       ...
                                       N(
                                           ...
                                           L<int?, int?, int?, int?, int?, int?, DateTime?>(
                                               ...
                                               Sql.Convert(
                                                   Sql.DateTime2,
                                                   y.ToString() + "-" + m.ToString() + "-" + d.ToString() + " " + h.ToString() + ":" + mm.ToString() + ":" + s.ToString())))
                                   },
                                   ...
                                   { M(() => Convert.ToBoolean((bool)true)), N(() => L<bool, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((byte)0)), N(() => L<byte, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((char)'0')), N(() => L<char, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
#if !SILVERLIGHT
                                   { M(() => Convert.ToBoolean(DateTime.Now)), N(() => L<DateTime, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
#endif
                                   { M(() => Convert.ToBoolean((decimal)0)), N(() => L<decimal, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((double)0)), N(() => L<double, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((short)0)), N(() => L<short, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((int)0)), N(() => L<int, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((long)0)), N(() => L<long, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((object)0)), N(() => L<object, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((sbyte)0)), N(() => L<sbyte, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((float)0)), N(() => L<float, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((string)"0")), N(() => L<string, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((ushort)0)), N(() => L<ushort, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((uint)0)), N(() => L<uint, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                                   { M(() => Convert.ToBoolean((ulong)0)), N(() => L<ulong, bool>(p0 => Sql.ConvertTo<bool>.From(p0))) },
                           ...
                           ProviderName.SqlServer, new Dictionary<MemberInfo, IExpressionInfo>
                                                   {
                                                       ...
                                                       { M(() => Sql.Trim("")), N(() => L<string, string>(p0 => Sql.TrimLeft(Sql.TrimRight(p0)))) },
                                                       {
                                                           ...
                                                           N(
                                                               () =>
                                                               L<int?, int?, int?, DateTime?>(
                                                                   (y, m, d) => DateAdd(Sql.DateParts.Month, (y.Value - 1900) * 12 + m.Value - 1, d.Value - 1)))
                                                       },
                                                       ...
                                                       {
                                                           {
                                                               ...
                                                               N(
                                                                   ...
                                                                   L<int?, int?, int?, int?, int?, int?, DateTime?>(
                                                                       ...
                                                                       Sql.Convert(
                                                                           Sql.DateTime2,
                                                                           y.ToString() + "-" + m.ToString() + "-" + d.ToString() + " " + h.ToString() + ":" + mm.ToString() + ":" +
                                                                           s.ToString(),
                                                                           120)))
                                                           },
                                                           { M(() => DateTime.Parse("")), N(() => L<string, DateTime>(p0 => Sql.ConvertTo<DateTime>.From(p0))) },
                                                     ...
                                                     N(
                                                         ...
                                                         L<Guid, string>(
                                                             ...
                                                             Sql.Lower(
                                                                 ...
                                                                 "-" + Sql.Substring(Hex(p), 11, 2) + Sql.Substring(Hex(p), 9, 2) + "-" + Sql.Substring(Hex(p), 15, 2) +
                                                                 Sql.Substring(Hex(p), 13, 2) + "-" + Sql.Substring(Hex(p), 17, 4) + "-" + Sql.Substring(Hex(p), 21, 12))))
                                                 },
...

                                                    {
                                                        ...
                                                        N(
                                                            ...
                                                            L<Guid, string>(
                                                                p =>
                                                                Sql.Lower(
                                                                    Sql.Substring(Sql.Convert2(Sql.Char(36), p), 7, 2) + Sql.Substring(Sql.Convert2(Sql.Char(36), p), 5, 2) +
                                                                    Sql.Substring(Sql.Convert2(Sql.Char(36), p), 3, 2) + Sql.Substring(Sql.Convert2(Sql.Char(36), p), 1, 2) + "-" +
                                                                    ...
                                                                    Sql.Substring(Sql.Convert2(Sql.Char(36), p), 17, 4) + "-" + Sql.Substring(Sql.Convert2(Sql.Char(36), p), 21, 12))))
                                                    },
                           ...
                           ProviderName.PostgreSQL, new Dictionary<MemberInfo, IExpressionInfo>
                                                    {
...

                                                        {
                                                            ...
                                                            N(() => L<double?, double?, double?>((m, n) => (double?)Sql.Log((decimal)m, (decimal)n).Value))
                                                        },
                                                        { M(() => Sql.Sinh(0)), N(() => L<double?, double?>(v => (Sql.Exp(v) - Sql.Exp(-v)) / 2)) },
                                                        { M(() => Sql.Tanh(0)), N(() => L<double?, double?>(v => (Sql.Exp(v) - Sql.Exp(-v)) / (Sql.Exp(v) + Sql.Exp(-v)))) },
...

                                                    {
                                                        ...
                                                        N(
                                                            ...
                                                            L<Guid, string>(
                                                                p =>
                                                                Sql.Lower(
                                                                    Sql.Substring(Hex(p), 7, 2) + Sql.Substring(Hex(p), 5, 2) + Sql.Substring(Hex(p), 3, 2) +
                                                                    Sql.Substring(Hex(p), 1, 2) + "-" + Sql.Substring(Hex(p), 11, 2) + Sql.Substring(Hex(p), 9, 2) + "-" +
                                                                    Sql.Substring(Hex(p), 15, 2) + Sql.Substring(Hex(p), 13, 2) + "-" + Sql.Substring(Hex(p), 17, 4) + "-" +
        ...
        static readonly Dictionary<string,Dictionary<TypeMember,IExpressionInfo>> _typeMembers = new Dictionary<string,Dictionary<TypeMember,IExpressionInfo>>
        {
            { "", new Dictionary<TypeMember,IExpressionInfo> {
                ...
                { MT<bool>(() => ((bool)true).ToString()), N(() => L<bool, string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<byte   >(() => ((byte)    0)  .ToString()), N(() => L<byte,    string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<char   >(() => ((char)   '0') .ToString()), N(() => L<char,    string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<decimal>(() => ((decimal) 0)  .ToString()), N(() => L<decimal, string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<double >(() => ((double)  0)  .ToString()), N(() => L<double,  string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<short  >(() => ((short)   0)  .ToString()), N(() => L<short,   string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<int  >(() => ((int)   0)  .ToString()), N(() => L<int,   string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<long  >(() => ((long)   0)  .ToString()), N(() => L<long,   string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<sbyte  >(() => ((sbyte)   0)  .ToString()), N(() => L<sbyte,   string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<float >(() => ((float)  0)  .ToString()), N(() => L<float,  string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
//				{ MT<String >(() => ((String) "0") .ToString()), N(() => L<String,  String>((String  p0) => p0                             )) },
                { MT<ushort >(() => ((ushort)  0)  .ToString()), N(() => L<ushort,  string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<uint >(() => ((uint)  0)  .ToString()), N(() => L<uint,  string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
                { MT<ulong >(() => ((ulong)  0)  .ToString()), N(() => L<ulong,  string>(p0 => Sql.ConvertTo<string>.From(p0) )) },
