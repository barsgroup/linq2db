...
{
    internal class OfTypeBuilder : MethodCallBuilder
    {
            ...
            BuildInfo buildInfo)
        {
            ...
            else
            {
                ...
                {
                    for (var type = toType.BaseTypeEx();
        ...
        private static ISqlPredicate MakeIsPredicate(ExpressionBuilder builder, IBuildContext context, Type fromType,
            Type toType)
        {
        ...
        private class OfTypeContext : PassThroughContext
        {
