...
namespace Bars2Db
{
    ...
    public class CompiledQuery
    {
        ...
        private volatile Func<object[], object> _compiledQuery;
        ...
        private TResult ExecuteQuery<TResult>(params object[] args)
        {
        ...
        private static Func<object[], object> CompileQuery(LambdaExpression query)
        {
                    ...
                    case ExpressionType.Call:
                    {
                        ...
                        if (expr.IsQueryable())
                        {
                            ...
                            var helper = (ITableHelper) Activator.CreateInstance(
                                typeof(TableHelper<>).MakeGenericType(qtype == null
                                    ? expr.Type
                                    : qtype.GetGenericArgumentsEx()[0]));
        ...
        {
            public Expression CallTable(LambdaExpression query, Expression expr, ParameterExpression ps,
                bool isQueriable)
            {
        ...
        public TResult Invoke<TDC, T1, T2, T3, T4, T5, TResult>(TDC dataContext, T1 arg1, T2 arg2, T3 arg3, T4 arg4,
            T5 arg5)
        {
        ...
        ///     Returned type of the delegate returned by the method.
        /// </typeparam>
        public static Func<TDC, TArg1, TArg2, TArg3, TArg4, TArg5, TResult> Compile
            <TDC, TArg1, TArg2, TArg3, TArg4, TArg5, TResult>(
